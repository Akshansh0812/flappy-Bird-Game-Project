...
def welcomeScreen():
    ...
    playery = int((SCREENWIDTH - GAME_SPRITES["player"].get_height()))
    basex = 0
...
def getRandomPipe():
    ...
    y2 = offset + random.randrange(
        0, int(SCREENHEIGHT - GAME_SPRITES["base"].get_height() - 1.5 * offset)
    )
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption("Flappy Bird by Akshansh")
